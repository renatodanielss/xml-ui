...
import { CdkDrag, CdkDragDrop, CdkDragMove, CdkDropList, CdkDropListGroup, CdkDragEnter, moveItemInArray } from '@angular/cdk/drag-drop';
...
export class DragDropComponent implements OnInit {
  ...
  public onChangeCheckbox(item: any): void {
    item.visible = !item.visible;
  }

  // Drag and Drop
  public dragMoved(e: CdkDragMove) {
  ...
  public dropListEnterPredicate = (drag: CdkDrag, drop: CdkDropList) => {
  ...
  public getPointerPositionOnPage(event: MouseEvent | TouchEvent) {
